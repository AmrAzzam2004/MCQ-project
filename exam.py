    ...
    with open("grades.csv", newline='') as csvfile:
        ...
        for row in reader:
            if len(row) >= 4 and row[0] == user_code:
                print(f"Subject: {row[1]}, Correct Answers: {row[2]}, Total Questions: {row[3]}")     
    ...
    if user_input == 1 :
        ...
        if user_input==1:
            ...
            if user_input == 1 : 
                ...
                csv_append("grades.csv", [user_code,user_name, "easy", correct_answers,num_questions])
                input("press any key")
            ...
            if user_input == 2 :
                ...
                correct_answers = ask_questions(questions, num_questions)
                print(f"\nYou got {correct_answers} out of {num_questions} questions correct.")
                csv_append("grades.csv", [user_code,user_name, "intermediate", correct_answers,num_questions])
                input("press any key")
            ...
            if user_input == 3:
                ...
                correct_answers = ask_questions(questions, num_questions)
                print(f"\nYou got {correct_answers} out of {num_questions} questions correct.")
                csv_append("grades.csv", [user_code,user_name, "Hard", correct_answers,num_questions])
                input("press any key")
